        ...
        <div className="text-center max-w-6xl mx-auto">
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                key={index}
                className={`p-6 rounded-xl bg-gradient-to-br from-slate-800/50 to-slate-700/50 backdrop-blur-sm border border-slate-600 transition-all duration-500 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group relative p-8 rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-700/30 backdrop-blur-sm border border-slate-600 hover:border-transparent hover:shadow-2xl transition-all duration-300 overflow-hidden"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10 }}
                className="p-8 rounded-2xl bg-gradient-to-br from-slate-800/70 to-slate-700/50 backdrop-blur-sm border border-slate-600 hover:border-blue-400 hover:shadow-2xl transition-all duration-300"
              >
